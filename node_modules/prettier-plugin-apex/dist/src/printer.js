...
import { getTrailingComments, printComment, printDanglingComment, } from "./comments.js";
...
import { checkIfParentIsDottedExpression, getPrecedence, isBinaryish, } from "./util.js";
...
nodeHandler[APEX_TYPES.THROW_STATEMENT] = (path, print) => [
    "throw",
    " ",
...
nodeHandler[APEX_TYPES.TRIGGER_VARIABLE_EXPRESSION] = (path, print) => ["Trigger", ".", path.call(print, "variable")];
...
nodeHandler[APEX_TYPES.CLASS_REF_EXPRESSION] = (path, print) => [path.call(print, "type"), ".", "class"];
...
nodeHandler[APEX_TYPES.LIMIT_VALUE] = (path, print) => [
    "LIMIT",
    " ",
    path.call(print, "i"),
];
nodeHandler[APEX_TYPES.LIMIT_EXPRESSION] = (path, print) => [
    "LIMIT",
    " ",
    path.call(print, "expr"),
];
nodeHandler[APEX_TYPES.OFFSET_VALUE] = (path, print) => [
    "OFFSET",
    " ",
    path.call(print, "i"),
];
nodeHandler[APEX_TYPES.OFFSET_EXPRESSION] = (path, print) => [
    "OFFSET",
    " ",
    path.call(print, "expr"),
];
nodeHandler[APEX_TYPES.QUERY_OPERATOR] = (childClass) => QUERY[childClass];
...
nodeHandler[APEX_TYPES.WHERE_COMPOUND_OPERATOR] = (childClass) => QUERY_WHERE[childClass];
nodeHandler[APEX_TYPES.SEARCH_USING_CLAUSE] = (path, print) => ["USING", " ", path.call(print, "type")];
...
nodeHandler[APEX_TYPES.WITH_IDENTIFIER] = (path, print) => [
    "WITH",
    " ",
